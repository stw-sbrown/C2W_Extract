...
-- ---------   ----------  --------   --------------------------------------------------
-- V 1.04      19/05/2016  S.Badhan   Enable parallel processing. Change to create table.
-- V 1.03      18/04/2016  S.Badhan   Change criteria for selection from ECT
-- V 1.03      15/04/2016  S.Badhan   ECT is now in CIS schema
-- V 1.02      11/04/2016  S.Badhan   SQL from Phils email - 07/04/2016
--                                    Amended truncate and insert into table rather than
--                                    drop/create table and to use ECG criteria.                                       
-- V 1.01      15/03/2016  S.Badhan   SQL from Phils email - 15/03/2016
--                                    Use criteria for selection from ECT
