...
-- V0.10    08/10/2016    K.Burton        Updated inserts to x-border ctrl table - no longer need to output x-border files
------------------------------------------------------------------------------------------------------------
-- CHANGES
...
INSERT INTO BT_CROSSBORDER_CTRL (WHOLESALER_ID,RUN_FLAG) VALUES ('UNITED-W',0);
INSERT INTO BT_CROSSBORDER_CTRL (WHOLESALER_ID,RUN_FLAG) VALUES ('SOUTHSTAFF-W',0);
COMMIT;
