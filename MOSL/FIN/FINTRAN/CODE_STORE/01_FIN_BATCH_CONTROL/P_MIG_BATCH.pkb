...
-- ---------   ---------------     -------        --------------------------------------
-- V 0.01      08/08/2016          S.Badhan       Initial Draft
----------------------------------------------------------------------------------------
...
BEGIN
   ...
   -- 1. Supply Point
   g_proc_name := 'P_FIN_TRAN_SUPPLY_POINT';
   ...
   P_FIN_TRAN_SUPPLY_POINT(g_no_batch, g_no_job, return_code);  
   ...
   -- 2. Service Component
   g_proc_name := 'P_FIN_TRAN_SERVICE_COMPONENT';
   l_progress := 'Get job parameters ' || g_proc_name;
   FN_GETJOB_PARMS; 
   return_code := 0;
   l_progress := 'Calling MO Extract procedure - ' || g_proc_name ;
   DBMS_OUTPUT.PUT_LINE(l_progress);
   P_FIN_TRAN_SERVICE_COMPONENT(g_no_batch, g_no_job, return_code);  
   ...
   -- 3. Discharge Point
   g_proc_name := 'P_FIN_TRAN_DISCHARGE_POINT';
   l_progress := 'Get job parameters ' || g_proc_name;
   FN_GETJOB_PARMS; 
   return_code := 0;
   l_progress := 'Calling MO Extract procedure - ' || g_proc_name ;
   DBMS_OUTPUT.PUT_LINE(l_progress);
   P_FIN_TRAN_DISCHARGE_POINT(g_no_batch, g_no_job, return_code);  
   ...
   -- 3a. Calculated Discharge
   g_proc_name := 'P_FIN_TRAN_CALC_DISCHARGE';
   l_progress := 'Get job parameters ' || g_proc_name;
   FN_GETJOB_PARMS; 
   return_code := 0;
   l_progress := 'Calling MO Extract procedure - ' || g_proc_name ;
   DBMS_OUTPUT.PUT_LINE(l_progress);
   P_FIN_TRAN_CALC_DISCHARGE(g_no_batch, g_no_job, return_code);  
   ...
   -- 4. Meter   
   g_proc_name := 'P_FIN_TRAN_METER';
   l_progress := 'Get job parameters ' || g_proc_name;
   FN_GETJOB_PARMS; 
   return_code := 0;
   l_progress := 'Calling MO Extract procedure - ' || g_proc_name ;
   DBMS_OUTPUT.PUT_LINE(l_progress);
   P_FIN_TRAN_METER(g_no_batch, g_no_job, return_code);  
   ...
   -- 5. Meter Reading
   g_proc_name := 'P_FIN_TRAN_METER_READING';
   l_progress := 'Get job parameters ' || g_proc_name;
   FN_GETJOB_PARMS; 
   return_code := 0;
   l_progress := 'Calling MO Extract procedure - ' || g_proc_name ;
   DBMS_OUTPUT.PUT_LINE(l_progress);
   P_FIN_TRAN_METER_READING(g_no_batch, g_no_job, return_code);  
   ...
   g_proc_name := 'P_FIN_TRAN_METER_SPID_ASSOC';
   l_progress := 'Get job parameters ' || g_proc_name;
   FN_GETJOB_PARMS; 
   return_code := 0;
   l_progress := 'Calling MO Extract procedure - ' || g_proc_name ;
   DBMS_OUTPUT.PUT_LINE(l_progress);
   P_FIN_TRAN_METER_SPID_ASSOC(g_no_batch, g_no_job, return_code);  
   ...
   -- 7. Meter Network
   g_proc_name := 'P_FIN_TRAN_METER_NETWORK';
   l_progress := 'Get job parameters ' || g_proc_name;
   FN_GETJOB_PARMS; 
   return_code := 0;
   l_progress := 'Calling MO Extract procedure - ' || g_proc_name ;
   DBMS_OUTPUT.PUT_LINE(l_progress);
   P_FIN_TRAN_METER_NETWORK(g_no_batch, g_no_job, return_code);  
   ...
   -- 8. Meter DPID cross reference
   g_proc_name := 'P_FIN_TRAN_METER_DPID_XREF';
   l_progress := 'Get job parameters ' || g_proc_name;
   FN_GETJOB_PARMS; 
   return_code := 0;
   l_progress := 'Calling MO Extract procedure - ' || g_proc_name ;
   DBMS_OUTPUT.PUT_LINE(l_progress);
   P_FIN_TRAN_METER_DPID_XREF(g_no_batch, g_no_job, return_code);  
