...
--
-- FILENAME       		: 	FINTRAN_BATCH_START.sql
--
-- CREATED        		: 	02/08/2016
--	
-- Subversion $Revision: 5283 $
--
-- DESCRIPTION 		   	: 	Runs FINTRAN batch schedule
...
-- --------  ---------- -------   --------------------------------------------------------------------------
-- V0.01     02/08/2016 S.Badhan  Initial version.
-- 
------------------------------------------------------------------------------------------------------------


PROMPT 'Switch off ALL FK constraints';
...
ALTER TABLE MO_METER DISABLE CONSTRAINT FK_MT_PROPERTY;
ALTER TABLE MO_METER_NETWORK DISABLE CONSTRAINT FK_MN_MAINPROPERTY;
ALTER TABLE MO_METER_NETWORK DISABLE CONSTRAINT FK_MN_SUBPROPERTY;
ALTER TABLE MO_METER_DPIDXREF DISABLE CONSTRAINT FK_MD_PROPERTY;
ALTER TABLE MO_METER_READING DISABLE CONSTRAINT FK_MR_PROPERTY;
ALTER TABLE MO_METER_SPID_ASSOC DISABLE CONSTRAINT FK_MS_PROPERTY;
ALTER TABLE MO_DISCHARGE_POINT DISABLE CONSTRAINT FK_DP_PROPERTY;
ALTER TABLE MO_SERVICE_COMPONENT DISABLE CONSTRAINT FK_SC_PROPERTY_PK03;
...
PROMPT 'Switch FK constraints back on';
...
ALTER TABLE MO_METER ENABLE CONSTRAINT FK_MT_PROPERTY;
ALTER TABLE MO_METER_NETWORK ENABLE CONSTRAINT FK_MN_MAINPROPERTY;
ALTER TABLE MO_METER_NETWORK ENABLE CONSTRAINT FK_MN_SUBPROPERTY;
ALTER TABLE MO_METER_DPIDXREF ENABLE CONSTRAINT FK_MD_PROPERTY;
ALTER TABLE MO_METER_READING ENABLE CONSTRAINT FK_MR_PROPERTY;
ALTER TABLE MO_METER_SPID_ASSOC ENABLE CONSTRAINT FK_MS_PROPERTY;
ALTER TABLE MO_DISCHARGE_POINT ENABLE CONSTRAINT FK_DP_PROPERTY;
ALTER TABLE MO_SERVICE_COMPONENT ENABLE CONSTRAINT FK_SC_PROPERTY_PK03;

commit;

-- Execute the TARIFF procedure

PROMPT 'Running Tariff package';
...
PROMPT 'Running Main Batch';
set serveroutput on;
execute  P_MIG_BATCH.P_STARTBATCH();
set serveroutput off;
