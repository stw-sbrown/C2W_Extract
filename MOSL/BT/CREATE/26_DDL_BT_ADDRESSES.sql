...
-- V 0.03      31/10/2016  S.Badhan   Added Index
------------------------------------------------------------------------------------------
...
CREATE INDEX IDX_ADDR_MKR ON BT_ADDRESSES (PROPERTY_ADDR_MKR, METER_ADDR_MKR, CUST_ADDR_MKR, CD_ADDR_TYPE);
