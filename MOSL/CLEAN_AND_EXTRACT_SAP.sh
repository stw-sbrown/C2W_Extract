...
#rm -r /CODE_STORE/30_SAPDEL_BATCH_CONTROL
#rm -r /CODE_STORE/31_SAPDEL_POD_CREATE
#rm -r /CODE_STORE/32_SAPDEL_UTILS
#rm -r /CODE_STORE/33_SAPDEL_DEV_CREATE
#rm -r /CODE_STORE/34_SAPDEL_CON_CHANGE
#rm -r /CODE_STORE/36_SAPDEL_PREM_CREATE
#rm -r /CODE_STORE/37_SAPDEL_INST_CREATE
#rm -r /CODE_STORE/38_SAPDEL_PODSERV_CREATE
#rm -r /CODE_STORE/39_SAPDEL_REG_CREATE
#rm -r /CODE_STORE/40_SAPDEL_METER_READ_CREATE
#rm -r /CODE_STORE/41_SAPTRAN_ADDRESS
#rm -r /CODE_STORE/42_SAPDEL_BP_CHANGE
#rm -r /CODE_STORE/43_SAPTRAN_BATCH_CONTROL
