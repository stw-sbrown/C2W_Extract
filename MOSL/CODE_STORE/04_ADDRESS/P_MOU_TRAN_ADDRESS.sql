...
IS
  ...
  BEGIN
    ...
    SELECT
      /*+ PARALLEL(KGEN,12) PARALLEL(T046,12) PARALLEL(TAD,12) PARALLEL(T022,12) */
      DISTINCT
      FGN.CD_ADDRESS,
    ...
    INTO BT_FOREIGN_ADDRESSES       
    SELECT
      /*+ PARALLEL(KGEN,12) PARALLEL(T046,12) PARALLEL(TAD,12) PARALLEL(T037,12) */
      DISTINCT
      FGN.CD_ADDRESS,
      KGEN.NO_LEGAL_ENTITY ,
      KGEN.NO_ACCOUNT,
