create or replace
PROCEDURE P_FIN_TRAN_METER_NETWORK (no_batch     IN MIG_BATCHSTATUS.NO_BATCH%TYPE,
...
-- CREATED        : 02/08/2016
--
-- DESCRIPTION    : Procedure to populate MO_ METER_NETWORK table in FINTRAN
--                 Will read from reception.SAP_METER_NETWORK and OWC_METER_READING tables
-- NOTES  :
...
-----------------------------------------------------------------------------------------
  ...
  c_module_name                 CONSTANT VARCHAR2(30) := 'P_FIN_TRAN_METER_NETWORK';
  c_company_cd                  CONSTANT VARCHAR2(4) := 'STW1';
  l_error_number                VARCHAR2(255);
  l_error_message               VARCHAR2(512);
  L_PROGRESS                    varchar2(100);
  L_PREV_MET                    MO_METER_READING.METERREF%type;  --modify
  ...
  L_HLT                         RECEPTION.SAP_METER%ROWTYPE;
  S_HLT                         RECEPTION.SAP_METER%ROWTYPE;
