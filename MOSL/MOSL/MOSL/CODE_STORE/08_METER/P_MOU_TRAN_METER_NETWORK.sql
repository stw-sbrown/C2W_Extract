  ...
  CREATE OR REPLACE PROCEDURE P_MOU_TRAN_METER_NETWORK (no_batch IN MIG_BATCHSTATUS.NO_BATCH%TYPE,
...
--              AND BTM.NO_PROPERTY = TV163M.NO_PROPERTY)
          ...
          JOIN BT_TVP163 TV163S ON (TV163S.NO_PROPERTY_INST = TV163M.NO_PROPERTY
              AND TV163S.NO_EQUIPMENT = TV163M.NO_EQUIPMENT
...
--              AND BTS.NO_PROPERTY = TV163S.NO_PROPERTY)
          ...
          --WHERE  TV163M.NO_EQUIPMENT BETWEEN 1 AND 999999999
              ...
              --AND TV163S.NO_PROPERTY_INST = 202002246
-- ****** V 0.02 - REOPENED Issue I-118 removed link to BT_METER_SPID and replaced with LU_SPID_RANGE for water meters only        
--      )
--      PIVOT (
--          MAX(MAIN_SPID_PK)
