...
-- 6, Altered for SAPTRAN

----------------------------- Modification History ---------------------------------------   
--
-- Version     Date        Author      Description
-- ---------   ----------  -------     ---------------------------------------------------
-- V 0.02      18/10/2016  S.Badhan    Amend for new constraints added
-- V 0.01      13/04/2016  N.Henderson Initial version.
-----------------------------------------------------------------------------------------
...
--alter table SAP_PROPERTY_ADDRESS DISABLE constraint FK_SPA_STWPROPERTYNUMBER_PK03;
--alter table SAP_PROPERTY_ADDRESS DISABLE constraint FK_SPA_ADDRESS_PK02;
alter table SAP_PROPERTY_ADDRESS DISABLE constraint FK_STWPROPERTYNUMBER_PK03;
alter table SAP_PROPERTY_ADDRESS DISABLE constraint FK_ADDRESS_PK02;
--alter table SAP_METER_ADDRESS DISABLE constraint FK_SMA_METER_ADDRESS_MAN_COMP;
--alter table SAP_METER_ADDRESS DISABLE constraint FK_SMA_ADDRESS_PK03;
alter table SAP_METER_ADDRESS DISABLE constraint FK_METER_ADDRESS_MAN_COMP;
alter table SAP_METER_ADDRESS DISABLE constraint FK_ADDRESS_PK03;
--alter table SAP_CUST_ADDRESS DISABLE constraint FK_SCA_ADDRESS_PK01;
alter table SAP_CUST_ADDRESS DISABLE constraint FK_ADDRESS_PK01;
...
TRUNCATE TABLE SAP_CUST_ADDRESS;
TRUNCATE TABLE SAP_METER_ADDRESS;
TRUNCATE TABLE SAP_PROPERTY_ADDRESS;
TRUNCATE TABLE SAP_ADDRESS;
...
--alter table SAP_PROPERTY_ADDRESS enable constraint FK_SPA_STWPROPERTYNUMBER_PK03;
--alter table SAP_PROPERTY_ADDRESS enable constraint FK_SPA_ADDRESS_PK02;
alter table SAP_PROPERTY_ADDRESS ENABLE constraint FK_STWPROPERTYNUMBER_PK03;
alter table SAP_PROPERTY_ADDRESS ENABLE constraint FK_ADDRESS_PK02;
--alter table SAP_METER_ADDRESS enable constraint FK_SMA_METER_ADDRESS_MAN_COMP;
--alter table SAP_METER_ADDRESS enable constraint FK_SMA_ADDRESS_PK03;
alter table SAP_METER_ADDRESS enable constraint FK_METER_ADDRESS_MAN_COMP;
alter table SAP_METER_ADDRESS ENABLE constraint FK_ADDRESS_PK03;
--alter table SAP_CUST_ADDRESS enable constraint FK_SCA_ADDRESS_PK01;
alter table SAP_CUST_ADDRESS DISABLE constraint FK_ADDRESS_PK01;
commit;
