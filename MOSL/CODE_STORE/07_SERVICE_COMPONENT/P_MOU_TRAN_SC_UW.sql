CREATE OR REPLACE PROCEDURE P_MOU_TRAN_SC_UW(no_batch          IN MIG_BATCHSTATUS.NO_BATCH%TYPE,
...
--
-- Subversion $Revision: 4653 $
--
-- CREATED        : 15/03/2016
--
-- DESCRIPTION    : Procedure to hold details of Unmeasured service provIsions
--                  Will write to temporary table BT_SC_UW.
-- NOTES  :
...
WHEN OTHERS THEN     
     ...
     P_MIG_BATCH.FN_UPDATEJOB(no_batch, l_job.NO_INSTANCE, l_job.IND_STATUS);
     return_code := -1;
END P_MOU_TRAN_SC_UW;
/
show error;

--CREATE OR REPLACE PUBLIC SYNONYM P_MOU_TRAN_SC_UW FOR P_MOU_TRAN_SC_UW;
