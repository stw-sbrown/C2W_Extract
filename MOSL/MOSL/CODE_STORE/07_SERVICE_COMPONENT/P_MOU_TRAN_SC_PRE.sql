CREATE OR REPLACE PROCEDURE P_MOU_TRAN_SC_PRE(no_batch          IN MIG_BATCHSTATUS.NO_BATCH%TYPE,
...
BEGIN
  ...
  INSERT INTO BT_SP_TARIFF_ALGITEM
  (CD_SERV_PROV, 
   CD_TARIFF, 
   CD_ALGORITHM,
   CD_BILL_ALG_ITEM, 
  ...
  INSERT INTO BT_SP_TARIFF_REFTAB (
     CD_SERV_PROV, 
     CD_TARIFF,
     CD_ALGORITHM,
     TP_EQUIPMENT,
  ...
  INSERT INTO BT_SP_TARIFF_EXTREF
  ...
  AND    t058.DT_START            <> nvl(t058.DT_END,to_date('31/12/2099','dd/mm/yyyy')) 
  ...
  INSERT INTO BT_SPR_TARIFF_ALGITEM
  ...
  CD_BILL_ALG_ITEM, DT_START, DT_END, DS_VALUE, DT_VALUE, NO_VALUE, TP_REF_TAB, CD_REF_TAB
  FROM (
  SELECT tspr.CD_COMPANY_SYSTEM, tspr.NO_PROPERTY, tspr.NO_SERV_PROV, tspr.NO_COMBINE_054, tspr.CD_SERV_PROV, tspr.CD_TARIFF, tspr.NO_TARIFF_GROUP, tspr.NO_TARIFF_SET,
  ...
  INSERT INTO BT_SPR_TARIFF_EXTREF
  (CD_COMPANY_SYSTEM, NO_PROPERTY, NO_SERV_PROV, NO_COMBINE_054, CD_SERV_PROV, CD_TARIFF, NO_TARIFF_GROUP, NO_TARIFF_SET,
  ...
  INSERT INTO BT_SP_TARIFF_SPLIT 
