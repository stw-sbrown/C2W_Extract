...
printf "\nRebuilding 10B-DELIVERY Ref Data" | tee -a /recload/$1/MOSL/LOGS/PROC_BUILD/PROC_BUILD_$1_MOUDEL-$timestamp.log 2>&1
sqlplus -s MOUDEL/$1 @/recload/$1/MOSL/CODE_STORE/10B_DEL_UTILITY/P_DEL_UTIL_REF_DATA.sql >> /recload/$1/MOSL/LOGS/PROC_BUILD/PROC_BUILD_$1_MOUDEL-$timestamp.log 2>&1
printf "\nRebuilding 10B-DELIVERY Batch Stats" | tee -a /recload/$1/MOSL/LOGS/PROC_BUILD/PROC_BUILD_$1_MOUDEL-$timestamp.log 2>&1
sqlplus -s MOUDEL/$1 @/recload/$1/MOSL/CODE_STORE/10B_DEL_UTILITY/P_DEL_UTIL_BATCH_STATS.sql >> /recload/$1/MOSL/LOGS/PROC_BUILD/PROC_BUILD_$1_MOUDEL-$timestamp.log 2>&1
...
printf "\nRebuilding 10C GIS Function procedure" | tee -a /recload/$1/MOSL/LOGS/PROC_BUILD/PROC_BUILD_$1_MOUDEL-$timestamp.log 2>&1
sqlplus -s MOUDEL/$1 @/recload/$1/MOSL/CODE_STORE/10C_DEL_FUNCTIONS/FN_VALIDATE_GIS.sql >> /recload/$1/MOSL/LOGS/PROC_BUILD/PROC_BUILD_$1_MOUDEL-$timestamp.log 2>&1
...
sqlplus -s MOUDEL/$1 @/recload/$1/MOSL/DEL/CREATE/10_DEL_ENABLE_TRIGGERS.sql >> /recload/$1/MOSL/LOGS/PROC_BUILD/PROC_BUILD_$1_MOUDEL-$timestamp.log 2>&1
