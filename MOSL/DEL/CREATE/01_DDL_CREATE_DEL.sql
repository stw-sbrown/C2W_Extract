...
-- V0.05                28/04/2016              K.Burton        Added named constraints to DEL_METER_SUPPLY_POINT
--                                                              and DEL_METER_NETWORK - Issue I-197
-- V0.06                16/05/2016              K.Burton        Added BT_CROSSBORDER_CTRL table for crossborder files
------------------------------------------------------------------------------------------------------------
...
(
MANUFACTURERSERIALNUM_PK VARCHAR(32) CONSTRAINT CH01_MSPSERIALNUM NOT NULL ,
MANUFACTURER_PK VARCHAR(32) CONSTRAINT CH01_MSPMANUFACTURER NOT NULL ,
SPID_PK VARCHAR(13) CONSTRAINT CH01_MSPSPIDPK NOT NULL
);
...
(
SPID_PK VARCHAR(13) CONSTRAINT CH01_MNSPIDPK NOT NULL,
MAINMANUFACTURERSERIALNUM VARCHAR(32) CONSTRAINT CH01_MNMAINSERIAL NOT NULL,
MAINMANUFACTURER VARCHAR(32) CONSTRAINT CH01_MNMAINMANUFACTURER NOT NULL,
MAINMETERTREATMENT VARCHAR (32) CONSTRAINT CH01_MNMAINTREATMENT NOT NULL,
SUBMANUFACTURERSERIALNUM VARCHAR(32) CONSTRAINT CH01_MNSUBSERIAL NOT NULL,
SUBMANUFACTURER VARCHAR(32) CONSTRAINT CH01_MNSUBMANUFACTURER NOT NULL,
SUBMETERTREATMENT VARCHAR(32) CONSTRAINT CH01_MNSUBTREATMENT NOT NULL
);
...
DPID_PK VARCHAR(32) CONSTRAINT CH03_DPID NOT NULL ,
...
(
DPID_PK VARCHAR(32) CONSTRAINT CH01_DPID NOT NULL,
...
CREATE TABLE BT_CROSSBORDER_CTRL
  (
    WHOLESALER_ID VARCHAR2(12 BYTE),
    RUN_FLAG      NUMBER
  );
