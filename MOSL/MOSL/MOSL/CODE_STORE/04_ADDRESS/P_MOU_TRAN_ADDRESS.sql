...
-- v 1.08    18/05/2016  K.Burton   Added ORDER BY claus to resolve primary key constraint errors on MO_ADDRESS
-----------------------------------------------------------------------------------------
...
CURSOR CUR_PROP_METER (p_no_property   BT_TVP054.NO_PROPERTY%TYPE) 
  IS
  SELECT DISTINCT mtr.MANUFACTURERSERIALNUM_PK AS NO_UTL_EQUIP,MTR.MANUFACTURER_PK as MANUFACTURER_PK
  FROM   MO_METER               mtr,
