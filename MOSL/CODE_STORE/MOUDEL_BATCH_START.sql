-- Subversion $Revision: 4121 $
--
--DISABLE FOREIGN CONSTRAINTS
ALTER TABLE MOUDEL.DEL_METER_DISCHARGE_POINT DISABLE constraint FK02_METER_MAN_SERIAL_COMP;
ALTER TABLE MOUDEL.DEL_DISCHARGE_POINT DISABLE CONSTRAINT FK01_SPID_PK;
ALTER TABLE MOUDEL.DEL_METER_DISCHARGE_POINT DISABLE CONSTRAINT FK01_DPID_PK;
ALTER TABLE MOUDEL.DEL_CALCULATED_DISCHARGE DISABLE CONSTRAINT FK02_DPID_PK;
...
ALTER TABLE MOUDEL.DEL_METER_DISCHARGE_POINT ENABLE constraint FK02_METER_MAN_SERIAL_COMP;
ALTER TABLE MOUDEL.DEL_DISCHARGE_POINT ENABLE CONSTRAINT FK01_SPID_PK;
ALTER TABLE MOUDEL.DEL_METER_DISCHARGE_POINT ENABLE CONSTRAINT FK01_DPID_PK;
ALTER TABLE MOUDEL.DEL_CALCULATED_DISCHARGE ENABLE CONSTRAINT FK02_DPID_PK;
