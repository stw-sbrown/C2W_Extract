...
BEGIN
  ...
  SELECT /*+ full(t058) full(t054) */                                                                                            -- V 0.02
  ...
  EXECUTE IMMEDIATE 'ALTER INDEX BT_SPR_TARIFF_EXTREF UNUSABLE';   -- V 0.02
  ...
  COMMIT;
  EXECUTE IMMEDIATE 'ALTER INDEX BT_SPR_TARIFF_EXTREF REBUILD';     -- V 0.02
