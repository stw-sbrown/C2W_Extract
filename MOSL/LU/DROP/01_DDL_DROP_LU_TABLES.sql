...
-- v0.09       12/10/2016     S.Badhan    Add drop for SAP_SENSITIVE and SAP_SENSI_EMERGENCY_PLANS
...
DROP TABLE SAP_SEWERAGE_TREATMENT_WORKS PURGE;

DROP TABLE SAP_SENSITIVE PURGE;

DROP TABLE SAP_SENSI_EMERGENCY_PLANS PURGE;
