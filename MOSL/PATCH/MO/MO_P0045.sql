...
CREATE INDEX IDX_TARIFF_CODE ON MO_TARIFF_VERSION (TARIFFCODE_PK);
...
CREATE INDEX IDX_TARIFF_VERSION_SCA ON MO_TARIFF_TYPE_SCA (TARIFF_VERSION_PK);
...
CREATE INDEX IDX_TARIFF_VERSION_US ON MO_TARIFF_TYPE_US (TARIFF_VERSION_PK);
CREATE INDEX IDX_TARIFF_VERSION_UW ON MO_TARIFF_TYPE_UW (TARIFF_VERSION_PK);
CREATE INDEX IDX_TARIFF_VERSION_WCA ON MO_TARIFF_TYPE_WCA (TARIFF_VERSION_PK);
